...
int main() {
  ...
  check(l, -2, 1000000000, 0, "Linear Function");
  check(l, -100000000, -10000, -10001, "Linear Function");
  check(l, -100000000, 50000000, 0, "Linear Function");
